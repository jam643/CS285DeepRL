...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        global MAX_VIDEO_LEN  # Jesse: needed to make this global to have affect
        MAX_VIDEO_LEN = self.params['ep_len_video'] or self.params['ep_len']
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        for itr in range(n_iter):
            ...
            # randomly sample train_batch_size (e.g. 100) from all training trajectories (relabeled from expert thus far)
    ...
    def collect_training_trajectories(
        ...
        if itr == 0:
            with open(load_initial_expertdata, 'rb') as file:
                ...
                paths, envsteps_this_batch = expert_data, 0
        else:
            # TODO collect `batch_size` samples to be used for training
            # HINT1: use sample_trajectories from utils
            # HINT2: you want each of these collected rollouts to be of length self.params['ep_len']
            print("\nCollecting data to be used for training...")
            # num of paths = batch_size / ep_len
        ...
        if self.log_video:
            ...
            if itr == 0:
                train_video_paths = utils.sample_n_trajectories(self.env, expert_policy, MAX_NVIDEO, MAX_VIDEO_LEN,
                                                                True)
            else:
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            # samples transitions (e.g. 100) randomly from replay buffer eval_batch_size (e.g. 5000)
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths, training_logs):
        ...
        # num paths = eval_batch_size/ep_len
