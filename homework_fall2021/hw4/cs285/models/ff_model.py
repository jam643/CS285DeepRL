...
class FFModel(nn.Module, BaseModel):
    ...
    def forward(
        ...
        next_obs_pred = unnormalize(ptu.to_numpy(delta_pred_normalized), delta_mean, delta_std) + obs_unnormalized # TODO(Q1)
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        next_obs_pred, delta_pred_normalized = self.forward(observations, actions, data_statistics['obs_mean'],
